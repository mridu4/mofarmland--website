      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-3 gap-2 py-3 border-y border-gray-100 mb-4">
          <div className="text-center">
            <div className="text-[10px] text-gray-400 uppercase tracking-wider">Size</div>
            <div className="font-semibold text-sm text-charcoal">{property.size}</div>
          </div>
          <div className="text-center border-x border-gray-100">
            <div className="text-[10px] text-gray-400 uppercase tracking-wider">Deposit</div>
            <div className="font-semibold text-sm text-charcoal">{(property.deposit / 1000)}K</div>
          </div>
          <div className="text-center">
            <div className="text-[10px] text-gray-400 uppercase tracking-wider">Period</div>
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="text-right text-xs text-gray-500">
            <div>Monthly: ~{formatPrice(Math.round((property.installmentPrice - property.deposit) / 6))}</div>
          </div>
        </div>
